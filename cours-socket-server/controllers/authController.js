...
const AuthRegister = async(req, res) => {
    ...
    try {
        // on lui demande de promesse afin de savoir s'il va bien renvoyer les données
        await new Promise((resolve, reject) => {
            // si l'execution a bien eu lieu 
            connect.execute(select,[body.email],  function(err, results, fields) {
